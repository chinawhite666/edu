...
(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">请认真完成考核题。准备好了吗？<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        ...
        function judgeSkills(score) {
            var returnString;
            if (score >= 80) return config.resultComments.perfect;
